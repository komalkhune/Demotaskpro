    ...
    const location=useLocation();
     ...
     const {adminname} = location.state || {};
       ...
       const [searchAdmin, setSearchAdmin] = useState("");
        ...
        const totaltating=rateno.length;
        console.log(totaltating)
        ...
        useEffect(()=>{
          ...
          //  }
            ...
            const searchstore=()=>{
                ...
                const stores = storedata.filter((item) =>
            ...
            const searchadmin=()=>{
                ...
                const admins = admindata.filter((item) =>
    ...
    return(
        ...
        <div className={mystyle.mainpage}>
            ...
            <div className={mystyle.submainpage}>
                ...
                <p className={mystyle.aaa}>Welcome back, <strong>{adminname}.</strong>  From here, you can add admins and stores, manage records, and view all registered lists.</p>
