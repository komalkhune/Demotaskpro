...
import mystyle from "./Changepass.module.css"
         ...
         {/* <div className={mystyle.logincontainer}>
            <div className={mystyle.loginbox}>
               ...
               <label className={mystyle.lable}>Email</label>
                ...
                {/* <button className={mystyle.loginbtn} onClick={loginbtn}>submit</button>


                 {error && (
                <div className={mystyle.shopass}>
                 <div>
                    ...
                    <button className={mystyle.loginbtn} onClick={change}>Change</button>
                </div>
